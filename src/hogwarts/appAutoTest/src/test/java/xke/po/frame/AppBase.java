...
import xke.po.message.Message;
import xke.po.mine.Mine;
import xke.po.workstation.WorkStation;
...
public class AppBase {
    ...
    public WorkStation toWorkStation() {
        click(workstationID);
